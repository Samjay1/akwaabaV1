  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      TextFormField(
        ...
        enabled: enableEdit,
        style: TextStyle(color: enableEdit?textColorPrimary:textColorLight,
        ...
        decoration: InputDecoration(
          ...
          suffix: suffixTapFunction!=null? InkWell(
            ...
            child:  Icon(
              obscureText ? Icons.visibility : Icons.visibility_off,size: 19,
              color: Colors.grey,),
          ):null,
        ...
        maxLines: maxLines!=null&&maxLines!>=2?null:1,//if more than 2 lines is given,
        ...
        validator:(value){
          if(value!.isEmpty){
            return
              applyValidation!?
              hint.isEmpty? "you can't leave here empty":"Please input $hint" :null;
          }
        },
