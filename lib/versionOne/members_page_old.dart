...
class MembersPageOld extends StatefulWidget {
  final bool isMemberuser;
  const MembersPageOld({required this.isMemberuser, Key? key})
      : super(key: key);

  @override
  State<MembersPageOld> createState() => _MembersPageOldState();
}

class _MembersPageOldState extends State<MembersPageOld> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.isMemberuser ? "Members" : "Organization"),
      ),
