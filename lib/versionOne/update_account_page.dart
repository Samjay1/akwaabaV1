...
class _UpdateAccountPageState extends State<UpdateAccountPage> {
  ...
  final TextEditingController _controllerOrgPostalAddress =
      TextEditingController();
  final TextEditingController _controllerOrgContactPersonName =
      TextEditingController();
  final TextEditingController _controllerOrgContactPersonEmail =
      TextEditingController();
  final TextEditingController _controllerOrgContactPersonPhone =
      TextEditingController();
  ...
  openTextInputModalSheet(int socialMediaId,
  ...
  selectGroupOrDepartment() {
    displayCustomDropDown(
            options: ["Senior Staff", "Casual Worker"],
            context: context,
  ...
  selectDateJoined() {
    displayDateSelector(
            initialDate: _dateJoined ?? DateTime.now(), context: context)
        .then((value) {
      if (value != null) {
        setState(() {
          _dateJoined = value;
                ...
                child: Column(
                  children: [
                    ...
                    LabelWidgetContainer(
                        ...
                        child: FormButton(
                            label: twitterHandle ?? "Input Handle",
                            function: () {
                              openTextInputModalSheet(1,
                    ...
                    LabelWidgetContainer(
                        ...
                        child: FormButton(
                            label: facebookHandle ?? "Input Handle",
                            function: () {
                              openTextInputModalSheet(2,
                    ...
                    LabelWidgetContainer(
                        ...
                        child: FormButton(
                            label: instagramHandle ?? "Input Handle",
                            function: () {
                              openTextInputModalSheet(3,
                    ...
                    LabelWidgetContainer(
                        ...
                        child: FormButton(
                          label: selectedGroup ?? "Select a group",
                          function: () {
                            selectGroupOrDepartment();
                          },
                        )),
                    LabelWidgetContainer(
                        label: "Sub Group ",
                        child: FormButton(
                          label: selectedGroup ?? "Select a sub group",
                          function: () {
                            selectGroupOrDepartment();
                          },
                        )),
                    LabelWidgetContainer(
                        ...
                        child: FormButton(
                          label: _dateJoined != null
                              ? DateFormat("dd MMMM yyy").format(_dateJoined!)
                              : "Select Date",
                          function: () {
                            selectDateJoined();
                          },
    ...
    return Column(
      ...
      children: [
        ...
        LabelWidgetContainer(
            label: "Place of work",
            child: FormTextField(
              controller: _controllerPlaceWork,
            )),
        LabelWidgetContainer(
            label: "Education",
            child: FormButton(
        ...
        LabelWidgetContainer(
            label: "CV",
            child: FormButton(
              label: cvFile != null ? Path.basename(cvFile!.path) : "Upload CV",
              function: () {
                selectCVFile();
              },
            )),
