...
class DutyTrackerAssignNewDuty extends StatefulWidget {
  const DutyTrackerAssignNewDuty({Key? key}) : super(key: key);

  @override
  State<DutyTrackerAssignNewDuty> createState() => _DutyTrackerAssignNewDutyState();
}

class _DutyTrackerAssignNewDutyState extends State<DutyTrackerAssignNewDuty> {
