...
class ClientProvider extends ChangeNotifier {
  ...
  Future<void> login({required BuildContext context, var phoneEmail, var password}) async {
    debugPrint('PROVIDER LOGIN CLIENT');
    _showLoginProgressIndicator=true;
    UserApi().login(context:context,phoneEmail: phoneEmail, password: password).
    then((value){
