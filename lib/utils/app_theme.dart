...
class AppTheme {
  ...
  static ThemeData _buildMyTheme() {
    ...
    return base.copyWith(
      ...
      buttonTheme: base.buttonTheme.copyWith(buttonColor: primaryColor, textTheme: ButtonTextTheme.primary, ),
      ...
      textTheme: base.textTheme.copyWith(
          ...
          headline6: base.textTheme.headline6!.copyWith(color: textColorPrimary,fontFamily: "Rubik"),


          bodyText2: base.textTheme.bodyText2!.copyWith(color: textColorPrimary
              ,fontFamily: "Lato",fontSize: 16,fontWeight: FontWeight.w400),
          bodyText1: base.textTheme.bodyText1!.copyWith(color: textColorPrimary
            ,fontFamily: "Lato",) ),
